			...
			<MobileFooterContainer>
				...
				<MobileFooterRight>
					{window.location.pathname === ROUTES.Home.Root ? (
						<Link href={"https://docs.google.com/forms/d/e/1FAIpQLSdReLc9RYtxnrzHGu5kjkD9tcxjjfF6h4limrBF-owLD6Zozg/viewform?usp=send_form"}>
							<Button size="small">{t('apply for a Grant now')}</Button>
						</Link>
